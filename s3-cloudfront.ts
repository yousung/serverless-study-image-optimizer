        ...
        PhotoCdn: {
            ...
            Properties: {
                DistributionConfig: {
                    ...
                    Aliases: [
                        `${process.env.SUB_DOMAIN}.${process.env.INFRA_DOMAIN}.${process.env.ROOT_DOMAIN}`
                    ],
                    ViewerCertificate: {
        ...
        PhotoCdnDns: {
            ...
            Properties: {
                AliasTarget: {
                    ...
                    HostedZoneId: "Z03364961W55NTAWFUX3R",
                },
                HostedZoneName: `${process.env.ROOT_DOMAIN}.`,
                Name: `${process.env.SUB_DOMAIN}.${process.env.INFRA_DOMAIN}.${process.env.ROOT_DOMAIN}`,
                Type: "A",
            },
        },
    },
